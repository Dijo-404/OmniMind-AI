    ...
    <div className="relative w-full min-h-screen bg-[var(--bg-main)] text-[var(--text-primary)] selection:bg-blue-600 font-[family-name:var(--font-space-grotesk)] overflow-x-hidden">
                 ...
                 {/* Symmetrical Header */}
                  <div className="flex flex-col items-center gap-6 text-center">
                     <div className="relative group">
                       ...
                       <div className="w-20 h-20 rounded-[2rem] bg-blue-600 flex items-center justify-center shadow-[0_0_60px_rgba(59,130,246,0.3)] relative z-10 group-hover:rotate-12 transition-all">
               ...
               >
                  ...
                  <div className="flex flex-col items-center gap-8 relative z-10">
                    <div className="flex items-center gap-12">
                       <div className="w-24 h-24 rounded-3xl bg-[var(--bg-main)] border border-[var(--border-primary)] flex items-center justify-center animate-pulse shadow-2xl">
      ...
      <footer className="relative z-20 py-10 px-10 border-t border-[var(--border-primary)] bg-[var(--bg-main)] flex items-center justify-between">
         <div className="flex items-center gap-10">
           ...
           <span className="text-[12px] font-black tracking-[1rem] text-[var(--text-secondary)] opacity-20 uppercase">Vanguard Sanctuary Core</span>
         </div>
         <span className="text-[10px] font-black text-[var(--text-secondary)] opacity-10 tracking-[0.5em] uppercase">© 2026 OmniMind Research Labs</span>
      </footer>
